...
function updatepanggil(transid) {
    //console.log(episodeid);
    //return;
    $.ajax({
        url: url + 'index.php/panggilAntrian/updatepanggil',
        type: 'post',
        //dataType: 'json',
        //cache: false,
        data: {
...
function tampilantrian(d, i) {
    ...
    if (length > i) {
        ...
        if (nourut) {
            if (namapasien) {
                var utterance = new SpeechSynthesisUtterance("antrian " + nourut.replace('L', 'el').replace('-', '!') + "!" + namapasien.toLowerCase());
            } else {
                var utterance = new SpeechSynthesisUtterance("antrian " + nourut.replace('L', 'el'));
            }
        } else {
            var utterance = new SpeechSynthesisUtterance(namapasien.toLowerCase());
        }
        //let utterance = new SpeechSynthesisUtterance("antrian " + nourut + " / " + namapasien.toLowerCase() + " / dari " + poli);
...
function panggilantrian() {
    $.ajax({
        url: url + 'index.php/panggilAntrian/panggilantrian',
        type: 'post',
        data: {
            lantai: lantai,
            jenis: jenis
