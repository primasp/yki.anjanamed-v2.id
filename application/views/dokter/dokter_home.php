<div class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Dokter Dashboard</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="<?= base_url(); ?>assets/img/icons/calendar.svg" alt="">
                </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="<?= base_url(); ?>assets/img/icons/profile-add.svg" alt="">
                </div>
                <div class="dash-content dash-count">
                    <h4>New Patients</h4>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="<?= base_url(); ?>assets/img/icons/scissor.svg" alt="">
                </div>
                <div class="dash-content dash-count">
                    <h4>Operations</h4>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="<?= base_url(); ?>assets/img/icons/empty-wallet.svg" alt="">
                </div>
                <div class="dash-content dash-count">
                    <h4>Earnings</h4>
                    ...
                    <div class="chart-title patient-visit">
                        ...
                        <div>
                            <ul class="nav chat-user-total">
                                <li><i class="fa fa-circle current-users"></i>Male 75%</li>
                                <li><i class="fa fa-circle old-users"></i> Female 25%</li>
                            </ul>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="donut-chart-dash" class="chart-user-icon">
                        <img src="<?= base_url(); ?>assets/img/icons/user-icon.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="<?= base_url(); ?>assets/img/icons/dep-icon-01.svg" alt="">
                        </div>
                    ...
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="<?= base_url(); ?>assets/img/icons/dep-icon-02.svg" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>Dentist</h4>
                            <p>24%</p>
                    ...
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="<?= base_url(); ?>assets/img/icons/dep-icon-03.svg" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>ENT</h4>
                            <p>10%</p>
                    ...
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="<?= base_url(); ?>assets/img/icons/dep-icon-04.svg" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>Cardiologist</h4>
                            <p>15%</p>
                    ...
                    <div class="activity-top mb-0">
                        <div class="activity-boxs comman-flex-center">
                            <img src="<?= base_url(); ?>assets/img/icons/dep-icon-05.svg" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>Opthomology</h4>
                            <p>20%</p>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="table-image appoint-doctor">
                                        <img width="28" height="28" class="rounded-circle" src="<?= base_url(); ?>assets/img/profiles/avatar-02.jpg" alt="">
                                ...
                                <tr>
                                    ...
                                    <td class="table-image appoint-doctor">
                                        <img width="28" height="28" class="rounded-circle" src="<?= base_url(); ?>assets/img/profiles/avatar-03.jpg" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>Bernardo </td>
                                    <td class="table-image appoint-doctor">
                                        <img width="28" height="28" class="rounded-circle" src="<?= base_url(); ?>assets/img/profiles/avatar-04.jpg" alt="">
                                        <h2>Dr.Martin Doe</h2>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="table-image appoint-doctor">
                                        <img width="28" height="28" class="rounded-circle" src="<?= base_url(); ?>assets/img/profiles/avatar-05.jpg" alt="">
